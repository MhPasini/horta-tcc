...
var DATA = [
	...
	},
	{
		...
		"steps":[
			{"type": "plant_at", "target": "any", "target_crop": "any", "completed": false, "progress_step": true},
		]}],
	...
	},
	{
		...
		"objectives": [
		  { "info": "Plantar e ragar cenouras nas linhas 0, 2, 4", "has_progression": true, "progress_max": 18,
		"steps":[]},
		  { "info": "Plantar e ragar cebolas nas linhas 1, 3, 5", "has_progression": true, "progress_max": 18,
		"steps":[
